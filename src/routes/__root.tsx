...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Amsterdam Airbnb Consultation | Book Your 1-Hour Strategy Call" },
      {
        name: "description",
        content:
      ...
      { name: "author", content: "Amsterdam Airbnb Consultation" },
      {
        property: "og:title",
        content: "Amsterdam Airbnb Consultation | Book Your 1-Hour Strategy Call",
      },
      {
